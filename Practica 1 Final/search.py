...
def tree_search(problem, fringe):                                                               #
    ...
    while fringe:                                                                               #
        ...
        if problem.goal_test(node.state):                                                       #
            print "Nodos expandidos: %d" % (expanded)                                           #
            return node                                                                         #
...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            print "Nodos expandidos: %d" % (expandidos)
            return node
...
#############################################################################
                                                                            #
def BranchAndBound(problem, fringe):                                        #
    expandidos=0                                                            #
    fringe.append(Node(problem.initial))                                    #
    while fringe:                                                           #
        node = fringe.pop()                                                 #
...
def branch_and_bound(problem):                       #
    return BranchAndBound(problem,Cola())            #
                                                     #
def branch_and_bound_with_underestimation(problem):  #
    return tree_search(problem,ColaHeu(problem))     #
                                                     #
######################################################
