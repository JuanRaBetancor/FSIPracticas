...
class Cola(Queue):                                                                      #
    ...
    def __len__(self):                                                                  #
        return len(self.A)                                                              #
                                                                                        #
    """Anade elementos a la FIFO en funcion de su path_cost"""                          #
    def extend (self,items):                                                            #
        self.A.extend(items)                                                            #
        self.A.sort(key=lambda x: x.path_cost)                                          #
    """Devuelve el primer elemento de la FIFO"""                                        #
    def pop(self):                                                                      #
        return self.A.pop(0)                                                            #
                                                                                        #
class ColaHeu(Queue):                                                                   #
    ...
    def __len__(self):                                                                  #
        return len(self.A)                                                              #
                                                                                        #
    """Anado elementos en funcion de su heuristica"""                                   #
    def extend (self,items,problem):                                                    #
        self.A.extend(items)                                                            #
        """Heuristica: path cost mas la distancia en linea recta)"""                    #
        self.A.sort(key=lambda x: x.path_cost+problem.h(x))                             #
    """Devuelve el primer elemento de la FIFO"""                                        #
    def pop(self):                                                                      #
        return self.A.pop(0)                                                            #
                                                                                        #
